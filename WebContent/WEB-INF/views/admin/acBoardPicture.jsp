...
<div style="overflow:auto; width:900px; height:720px; vertical-align:middle; position: absolute; left: 950px;" >
	<c:forEach var="picture" items="${acBoardPicture}">
	 	<img id="fnImgPop" class="fnImgPop" src="<%=application.getContextPath()%>/resources/image/OneStar_photo/${picture.filename}" width="280px" height="240px" onclick="fnImgPop(this.src)"/> 
	</c:forEach>
</div>
